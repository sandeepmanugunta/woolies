...
public class MyWorkListPage extends BasePage {
    ...
    public List<WebElement> getProduct()  {
        ...
        By Product = By.cssSelector("a[class='s-item__link']");
    ...
    public WebElement getAddToCart()  {
        ...
        By AddToCart = By.id("atcRedesignId_btn");
    ...
    public WebElement getCheckout()  {
        ...
        By Checkout = By.cssSelector("a[class='btn btn-prim vi-VR-btnWdth-XL ']");
